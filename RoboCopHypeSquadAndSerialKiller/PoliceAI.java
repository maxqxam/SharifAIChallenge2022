...
public class PoliceAI extends AI {
    ...
    public void init(GameView view) {
        ...
        Agent.initialBalance = view.getBalance();
        Agent.copsIncome = view.getConfig().getIncomeSettings().getPoliceIncomeEachTurn();
        Agent.thievesIncome = view.getConfig().getIncomeSettings().getThievesIncomeEachTurn();
    ...
    {
        Agent.updateStatics(view.getVisibleAgentsList(),self.team,self,firstMove);
